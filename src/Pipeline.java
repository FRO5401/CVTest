...
public class Pipeline {
	...
	public void process() {
		...
		double[] hsvThresholdHue = {116.22275861643128, 180.0};
		double[] hsvThresholdSaturation = {130.34705145884368, 255.0};
		double[] hsvThresholdValue = {42.53429874861981, 255.0};
		hsvThreshold(hsvThresholdInput, hsvThresholdHue, hsvThresholdSaturation, hsvThresholdValue, hsvThresholdOutput);

		//Step  Mask0:
		Mat mask0Input = resizeImageOutput;
		Mat mask0Mask = hsvThresholdOutput;
		mask(mask0Input, mask0Mask, mask0Output);

		//Step  RGB_Threshold0:
		Mat rgbThresholdInput = mask0Output;
		double[] rgbThresholdRed = {69.97578561642749, 156.29869634454903};
		double[] rgbThresholdGreen = {0.0, 116.02785401339858};
		double[] rgbThresholdBlue = {0.0, 131.62337043068626};
		...
		//Step  Mask1:
		Mat mask1Input = resizeImageOutput;
		Mat mask1Mask = cvErodeOutput;
	    ...
	    System.out.println("Hulls Output Is Empty? " + convexHullsOutput.isEmpty());
